...
#ensure that we will be automatically redirected to the login html
DEBUG = True
...
SECRET_KEY = 'd+kdiy7a381-i1c!dts$zo@8fp1o+zu15&vl)!h=oo2)(7=z&k'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
	"F:\\Dropbox\\django_bookmarks\\templates"
)
import sys
